...
//                    .rowAtStartPoint().display(new PrintStream(byteArrayOutputStream7))
//                    .value().display(new PrintStream(byteArrayOutputStream8))
//                    .column().display(new PrintStream(byteArrayOutputStream9))
//                    .value().display(new PrintStream(byteArrayOutputStream10));
    ...
    Assertions.assertThat(byteArrayOutputStream4.toString()).isEqualTo(String.format("[Value at index 0 (column name : VAR1) of Row at index 0 of test table]%n"
                                                                                     ...
                                                                                     + "| 1        |%n"
                                                                                     + "|----------|%n"));
    Assertions.assertThat(byteArrayOutputStream5.toString()).isEqualTo(String.format(""));
    Assertions.assertThat(byteArrayOutputStream6.toString()).isEqualTo(String.format(""));
    Assertions.assertThat(byteArrayOutputStream7.toString()).isEqualTo(String.format(""));
    Assertions.assertThat(byteArrayOutputStream8.toString()).isEqualTo(String.format(""));
    Assertions.assertThat(byteArrayOutputStream9.toString()).isEqualTo(String.format(""));
    Assertions.assertThat(byteArrayOutputStream10.toString()).isEqualTo(String.format(""));
  }
