...
public class H2Database_Test extends AbstractH2Test {
  ...
  public void test_ColumnClass_isOfClass() {
    ...
    assertThat(table)
            ...
            .column("var14").isOfClass(Short.class, false)
            .column("var15").isOfClass(Byte.class, false)
            .column("var16").isOfClass(Byte.class, false)
            .column("var17").isOfClass(Byte.class, false)
            .column("var18").isOfClass(Byte.class, false)
            .column("var19").isOfClass(Byte.class, false)
            .column("var20").isOfClass(Byte.class, false)
            .column("var21").isOfClass(Byte.class, false)
  ...
  public void test_ValueClass_isOfClass() {
    ...
    assertThat(table).row()
                     ...
                     .value("var14").isOfClass(Short.class)
                     .value("var15").isOfClass(Byte.class)
                     .value("var16").isOfClass(Byte.class)
                     .value("var17").isOfClass(Byte.class)
                     .value("var18").isOfClass(Byte.class)
                     .value("var19").isOfClass(Byte.class)
                     .value("var20").isOfClass(Byte.class)
                     .value("var21").isOfClass(Byte.class)
