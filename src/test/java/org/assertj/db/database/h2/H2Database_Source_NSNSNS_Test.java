...
public class H2Database_Source_NSNSNS_Test extends AbstractH2Test {
  ...
  public void should_fail_because_column_name_is_different() {
    ...
    try {
      ...
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[Column at index 0 (column name : VAR1) of Change at index 0 of Changes on test table of 'sa/jdbc:h2:mem:testH2' source] %n"
                                                                    + "Expecting :%n"
                                                                    + "  \"Var1\"%n"
                                                                    + "to be the name of the column but was:%n"
                                                                    + "  \"VAR1\""));
    ...
    try {
      ...
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[Value at index 0 (column name : VAR1) of Row at end point of Change at index 0 of Changes on test table of 'sa/jdbc:h2:mem:testH2' source] %n"
                                                                    + "Expecting :%n"
                                                                    + "  \"Var1\"%n"
                                                                    + "to be the name of the column but was:%n"
                                                                    + "  \"VAR1\""));
