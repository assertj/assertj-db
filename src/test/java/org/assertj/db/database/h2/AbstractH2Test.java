...
public abstract class AbstractH2Test extends AbstractDatabaseTest {
  ...
  protected final AssertDbConnection jdbcConnectionDDD = AssertDbConnectionFactory.of("jdbc:h2:mem:testH2", "sa", "").letterCase(
    LetterCase.TABLE_DEFAULT,
    LetterCase.COLUMN_DEFAULT,
    LetterCase.PRIMARY_KEY_DEFAULT).create();
  protected final AssertDbConnection jdbcConnectionUIUIUI = AssertDbConnectionFactory.of("jdbc:h2:mem:testH2", "sa", "").letterCase(
    letterCaseUI,
    letterCaseUI,
    letterCaseUI).create();
  protected final AssertDbConnection jdbcConnectionNSNSNS = AssertDbConnectionFactory.of("jdbc:h2:mem:testH2", "sa", "").letterCase(
    letterCaseNS,
    letterCaseNS,
    letterCaseNS).create();
