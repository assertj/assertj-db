...
public class DefaultDescription_Test extends AbstractTest {
    ...
    public void test_default_description_for_change_with_different_informations() throws Exception {
        ...
        WritableAssertionInfo infoOnActorTable = (WritableAssertionInfo) field
            .get(assertThat(changesOnActorTable).change());
        ...
        assertThat(info.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of a data source");
        assertThat(infoOnActorTable.descriptionText())
            .isEqualTo("Change at index 0 (with primary key : [4]) of Changes on actor table of a data source");
        assertThat(infoOnTestTable.descriptionText())
            .isEqualTo("Change at index 8 (on table : TEST2) of Changes on tables of a data source");
        assertThat(infoOnRequest.descriptionText())
            .isEqualTo("Change at index 0 of Changes on 'select * from actor' request of a data source");
    }
    ...
    public void test_default_description_of_creation_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on tables of 'sa/jdbc:h2:mem:test' source (only creation changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on tables of a data source (only creation changes)");
    }
    ...
    public void test_default_description_of_modification_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on tables of 'sa/jdbc:h2:mem:test' source (only modification changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on tables of a data source (only modification changes)");
    }
    ...
    public void test_default_description_of_deletion_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on tables of 'sa/jdbc:h2:mem:test' source (only deletion changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on tables of a data source (only deletion changes)");
    }
    ...
    public void test_default_description_of_creation_on_table_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on tables of 'sa/jdbc:h2:mem:test' source (only creation changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on tables of a data source (only creation changes on actor table)");
    }
    ...
    public void test_default_description_of_modification_on_table_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on tables of 'sa/jdbc:h2:mem:test' source (only modification changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on tables of a data source (only modification changes on actor table)");
    }
    ...
    public void test_default_description_of_deletion_on_table_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on tables of 'sa/jdbc:h2:mem:test' source (only deletion changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on tables of a data source (only deletion changes on actor table)");
    }
    ...
    public void test_default_description_on_table_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on tables of 'sa/jdbc:h2:mem:test' source (only changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on tables of a data source (only changes on actor table)");
    }
    ...
    public void test_default_description_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on actor table of 'sa/jdbc:h2:mem:test' source");
    ...
    public void test_default_description_of_changes_on_request() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Changes on 'select * from actor' request of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Changes on 'select * from actor' request of a data source");
    }
    ...
    public void test_default_description_of_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 1 (on table : INTERPRETATION and with primary key : [6]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_of_change_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Change at index 2 (with primary key : [3]) of Changes on actor table of a data source");
    }
    ...
    public void test_default_description_of_change_of_changes_on_request() throws Exception {
        ...
        Request requestFromSource = new Request(source, "select id, name, firstname, birth from actor where id = 1")
            .setPksName("ID");
        Request requestFromDataSource = new Request(dataSource, "select * from actor").setPksName("ID");
        Changes changesFromSource = new Changes(requestFromSource).setStartPointNow();
        Changes changesFromDataSource = new Changes(requestFromDataSource).setStartPointNow();
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [1]) of Changes on 'select id, name, firstname, bi...' request of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 2 (with primary key : [3]) of Changes on 'select * from actor' request of a data source");
    }
    ...
    public void test_default_description_of_creation_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only creation changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of a data source (only creation changes)");
    }
    ...
    public void test_default_description_of_creation_change_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only creation changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on actor table of a data source (only creation changes)");
    }
    ...
    public void test_default_description_of_creation_change_of_changes_on_request() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on 'select * from actor' request of 'sa/jdbc:h2:mem:test' source (only creation changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on 'select * from actor' request of a data source (only creation changes)");
    }
    ...
    public void test_default_description_of_modification_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [1]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only modification changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [1]) of Changes on tables of a data source (only modification changes)");
    }
    ...
    public void test_default_description_of_modification_change_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [1]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only modification changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [1]) of Changes on actor table of a data source (only modification changes)");
    }
    ...
    public void test_default_description_of_modification_change_of_changes_on_request() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [1]) of Changes on 'select * from actor' request of 'sa/jdbc:h2:mem:test' source (only modification changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [1]) of Changes on 'select * from actor' request of a data source (only modification changes)");
    }
    ...
    public void test_default_description_of_deletion_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [3]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only deletion changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [3]) of Changes on tables of a data source (only deletion changes)");
    }
    ...
    public void test_default_description_of_deletion_change_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [3]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only deletion changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [3]) of Changes on actor table of a data source (only deletion changes)");
    }
    ...
    public void test_default_description_of_deletion_change_of_changes_on_request() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [3]) of Changes on 'select * from actor' request of 'sa/jdbc:h2:mem:test' source (only deletion changes)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [3]) of Changes on 'select * from actor' request of a data source (only deletion changes)");
    }
    ...
    public void test_default_description_of_creation_change_on_table_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only creation changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of a data source (only creation changes on actor table)");
    }
    ...
    public void test_default_description_of_creation_change_on_table_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only creation changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on actor table of a data source (only creation changes on actor table)");
    }
    ...
    public void test_default_description_of_modification_change_on_table_of_changes() throws Exception {
        ...
        ChangeAssert assertionFromDataSource = assertThat(changesFromDataSource)
            .changeOfModificationOnTable("actor", 0);

        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [1]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only modification changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [1]) of Changes on tables of a data source (only modification changes on actor table)");
    }
    ...
    public void test_default_description_of_modification_change_on_table_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [1]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only modification changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [1]) of Changes on actor table of a data source (only modification changes on actor table)");
    }
    ...
    public void test_default_description_of_deletion_change_on_table_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [3]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only deletion changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [3]) of Changes on tables of a data source (only deletion changes on actor table)");
    }
    ...
    public void test_default_description_of_deletion_change_on_table_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [3]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only deletion changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [3]) of Changes on actor table of a data source (only deletion changes on actor table)");
    }
    ...
    public void test_default_description_of_change_on_table_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of a data source (only changes on actor table)");
    }
    ...
    public void test_default_description_of_change_on_table_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 0 (with primary key : [4]) of Changes on actor table of a data source (only changes on actor table)");
    }
    ...
    public void test_default_description_of_change_on_table_with_pks_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 1 (on table : ACTOR and with primary key : [1]) of Changes on tables of 'sa/jdbc:h2:mem:test' source (only changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 1 (on table : ACTOR and with primary key : [1]) of Changes on tables of a data source (only changes on actor table)");
    }
    ...
    public void test_default_description_of_change_on_table_with_pks_of_changes_on_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Change at index 1 (with primary key : [1]) of Changes on actor table of 'sa/jdbc:h2:mem:test' source (only changes on actor table)");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Change at index 1 (with primary key : [1]) of Changes on actor table of a data source (only changes on actor table)");
    }
    ...
    public void test_default_description_column_of_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Column at index 0 (column name : ID) of Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Column at index 0 (column name : ID) of Change at index 1 (on table : INTERPRETATION and with primary key : [6]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_row_at_start_point_of_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Row at start point of Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Row at start point of Change at index 1 (on table : INTERPRETATION and with primary key : [6]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_row_at_end_point_of_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Row at end point of Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Row at end point of Change at index 1 (on table : INTERPRETATION and with primary key : [6]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_value_at_start_point_of_column_of_change_of_changes() throws Exception {
        ...
        ChangeColumnValueAssert assertionFromSource = assertThat(changesFromSource).change().column()
                                                                                   .valueAtStartPoint();
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Value at start point of Column at index 0 (column name : ID) of Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Value at start point of Column at index 0 (column name : ID) of Change at index 1 (on table : INTERPRETATION and with primary key : [6]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_value_at_end_point_of_column_of_change_of_changes() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Value at end point of Column at index 0 (column name : ID) of Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Value at end point of Column at index 0 (column name : ID) of Change at index 1 (on table : INTERPRETATION and with primary key : [6]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_value_of_row_at_start_point_of_change_of_changes() throws Exception {
        ...
        ChangeRowValueAssert assertionFromDataSource = assertThat(changesFromDataSource).change(3).rowAtStartPoint()
                                                                                        .value();

        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Value at index 0 (column name : ID) of Row at start point of Change at index 3 (on table : ACTOR and with primary key : [1]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Value at index 0 (column name : ID) of Row at start point of Change at index 3 (on table : ACTOR and with primary key : [1]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_value_of_row_at_end_point_of_change_of_changes() throws Exception {
        ...
        ChangeRowValueAssert assertionFromDataSource = assertThat(changesFromDataSource).change(1).rowAtEndPoint()
                                                                                        .value();

        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText()).isEqualTo(
            "Value at index 0 (column name : ID) of Row at end point of Change at index 0 (on table : ACTOR and with primary key : [4]) of Changes on tables of 'sa/jdbc:h2:mem:test' source");

        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText()).isEqualTo(
            "Value at index 0 (column name : ID) of Row at end point of Change at index 1 (on table : INTERPRETATION and with primary key : [6]) of Changes on tables of a data source");
    }
    ...
    public void test_default_description_of_column_of_table() throws Exception {
        ...
        WritableAssertionInfo infoFromDataSource = (WritableAssertionInfo) field.get(assertionFromDataSource);
        assertThat(infoFromDataSource.descriptionText())
            .isEqualTo("Column at index 0 (column name : ID) of actor table");
    }
    ...
    public void test_default_description_of_column_of_request() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Column at index 0 (column name : ID) of 'select * from actor' request");
    ...
    public void test_default_description_of_value_of_column_of_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Value at index 0 of Column at index 0 (column name : ID) of actor table");
    ...
    public void test_default_description_of_value_of_row_of_table() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Value at index 0 (column name : ID) of Row at index 0 of actor table");
    ...
    public void test_default_description_of_value_of_column_of_request() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Value at index 0 of Column at index 0 (column name : ID) of 'select * from actor' request");
    ...
    public void test_default_description_of_value_of_row_of_request() throws Exception {
        ...
        WritableAssertionInfo infoFromSource = (WritableAssertionInfo) field.get(assertionFromSource);
        assertThat(infoFromSource.descriptionText())
            .isEqualTo("Value at index 0 (column name : ID) of Row at index 0 of 'select * from actor' request");
