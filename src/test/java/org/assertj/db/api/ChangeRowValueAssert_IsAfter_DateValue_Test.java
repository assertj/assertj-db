 ...
 *
 */
public class ChangeRowValueAssert_IsAfter_DateValue_Test extends AbstractTest {
  ...
  public void should_fail_because_value_is_not_after() {
    try {
      ...
      assertThat(changes).change().rowAtEndPoint().value("var9")
                       .isAfter(DateValue.of(2014, 5, 24));
  ...
  public void should_fail_because_value_is_not_a_date() {
    try {
      ...
      assertThat(changes).change().rowAtEndPoint().value("var1")
                       .as("var1").isAfter(DateValue.of(2014, 5, 23));
  ...
  public void should_fail_because_datetime_value_is_not_after() throws ParseException {
    try {
      ...
      assertThat(changes).change(2).rowAtEndPoint().value("var10")
                       .isAfter(DateValue.parse("2014-05-30"));
