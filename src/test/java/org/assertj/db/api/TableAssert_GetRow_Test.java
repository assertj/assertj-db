...
public class TableAssert_GetRow_Test extends AbstractTest {
  ...
  public void test_when_get_rows_without_parameters() throws IllegalArgumentException, IllegalAccessException,
    ...
    assertThat(assertion.getRow()).isSameAs(table.getRow(0));
    assertThat(field.getInt(assertion)).isEqualTo(1);
    assertThat(assertion.getRow()).isSameAs(table.getRow(1));
    assertThat(field.getInt(assertion)).isEqualTo(2);
    assertThat(assertion.getRow()).isSameAs(table.getRow(2));
