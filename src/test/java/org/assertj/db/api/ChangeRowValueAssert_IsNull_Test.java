...
public class ChangeRowValueAssert_IsNull_Test extends AbstractTest {
  ...
  public void should_fail_because_value_is_not_null() {
    try {
      ...
      assertThat(e.getLocalizedMessage()).isEqualTo("[Value at index 9 of Row at end point of Change at index 0 of Changes on tables of 'sa/jdbc:h2:mem:test' source] expected:<null> but was:<2014-05-24T09:46:30>");
    }
  }
