...
/**
 * Test on the description methods on {@code Row}.
 * 
 * @author Régis Pouiller
 * 
 */
public class RowAssert_Description_Test extends AbstractTest {
  ...
  public void test_description_by_text() {
    ...
    TableRowAssert assertion = assertThat(table).row().as("test %s", "param");
  ...
  public void test_description_by_description() {
    ...
    RequestRowAssert assertion = assertThat(request).row().as(description);
