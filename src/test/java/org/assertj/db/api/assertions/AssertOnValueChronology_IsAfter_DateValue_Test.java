...
public class AssertOnValueChronology_IsAfter_DateValue_Test extends AbstractTest {
  ...
  public void test_is_after() throws ParseException {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isAfter(
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isAfter(DateValue.parse("2014-05-24"));
  ...
  public void should_fail_because_value_is_before_or_equal_to() throws ParseException {
    ...
    try {
      assertThat(table).column("var10").value().isAfter(DateValue.parse("2014-05-25"));
      fail("An exception must be raised");
    } catch (AssertionError e) {
