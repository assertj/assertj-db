...
public class AssertOnValueNonEquality_IsNotEqualTo_DateTimeValue_Test extends AbstractTest {
  ...
  public void test_is_not_equal_to() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isNotEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue
            .of(9, 46, 31)));
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isNotEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue
            .of(9, 46, 31)));
  ...
  public void should_fail_because_value_is_equal_to() {
    ...
    try {
      assertThat(changes).change().column("var10").valueAtEndPoint().isNotEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue
              .of(9, 46, 30)));
    ...
    try {
      assertThat(table).column("var10").value().isNotEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue
              .of(9, 46, 30)));
      fail("An exception must be raised");
    } catch (AssertionError e) {
