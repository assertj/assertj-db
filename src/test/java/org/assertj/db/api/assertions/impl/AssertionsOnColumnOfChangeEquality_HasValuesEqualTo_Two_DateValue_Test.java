 ...
 * {@link org.assertj.db.api.assertions.impl.AssertionsOnColumnOfChangeEquality#hasValuesEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, Object, Object, DateValue, DateValue)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnColumnOfChangeEquality_HasValuesEqualTo_Two_DateValue_Test {
  ...
  public void test_have_values_equal_to() {
    ...
    tableAssert2 = AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info,
            Timestamp.valueOf("2007-12-23 00:00:00"), Timestamp.valueOf("2002-07-25 00:00:00"),
            DateValue.of(2007, 12, 23), DateValue.of(2002, 7, 25));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
