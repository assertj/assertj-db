...
public class AssertOnRowEquality_HasValues_Test extends AbstractTest {
    ...
    public void test_has_values() {
        ...
        TableRowAssert tableRowAssert2 = tableRowAssert.hasValues(1, "Weaver", "Susan Alexandra", "1949-10-08",
                                                                  UUID.fromString(
    ...
    public void should_fail_because_values_are_different() {
        ...
        try {
            assertThat(changes).change().rowAtEndPoint().hasValues(4, "Murray", "Billy", "1950-09-21", UUID.fromString(
                "30B443AE-C0C9-4790-9BEC-CE1380808435"));
