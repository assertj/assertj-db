...
public class AssertOnValueChronology_IsAfter_DateTimeValue_Test extends AbstractTest {
  ...
  public void test_is_after() throws ParseException {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isAfter(DateTimeValue.parse("2014-05-24T09:46:29"));
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isAfter(DateTimeValue.parse("2014-05-24T09:46:29"));
  ...
  public void should_fail_because_value_is_before_or_equal_to() throws ParseException {
    ...
    try {
      assertThat(table).column("var10").value().isAfter(DateTimeValue.parse("2014-05-24T09:46:30"));
      fail("An exception must be raised");
    } catch (AssertionError e) {
