 ...
 * {@link AssertionsOnColumnEquality#hasValuesEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, java.util.List, String...)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnColumnEquality_HasValuesEqualTo_String_Test {
  ...
  public void test_have_values_equal_to() {
    ...
    TableAssert tableAssert2 = AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "test1", "test2", null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    list = new ArrayList<Object>(Arrays.asList(8, 9, null));
    tableAssert2 = AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "8", "9", null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    list = new ArrayList<Object>(Arrays.asList(Date.valueOf("2007-12-23"), Date.valueOf("2002-07-25"), null));
    tableAssert2 = AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "2007-12-23", "2002-07-25", null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    list = new ArrayList<Object>(Arrays.asList(Time.valueOf("09:01:00"), Time.valueOf("03:30:05"), null));
    tableAssert2 = AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "09:01", "03:30:05", null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    list = new ArrayList<Object>(Arrays.asList(Timestamp.valueOf("2007-12-23 09:01:00"), Timestamp.valueOf("2002-07-25 03:30:05"), null));
    tableAssert2 = AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "2007-12-23T09:01", "2002-07-25T03:30:05", null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
  ...
  public void should_fail_because_values_are_different() {
    ...
    try {
      ...
      AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "test1", "test2");
    ...
    try {
      ...
      AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "7", "9");
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
                                                      + "Expecting that the value at index 0:\n"
    ...
    try {
      ...
      AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "2007-12-23", "2002-07-26");
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
    ...
    try {
      ...
      AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "09:01", "03:30:06");
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
                                                      + "Expecting that the value at index 1:\n"
    ...
    try {
      ...
      AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "2007-12-23T09:01", "2002-07-25T03:30:06");
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
                                                      + "Expecting that the value at index 1:\n"
  ...
  public void should_fail_because_the_number_of_values_is_different() {
    ...
    try {
      AssertionsOnColumnEquality.hasValuesEqualTo(tableAssert, info, list, "test1", "test2", "test3");
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
