 ...
 * {@link org.assertj.db.api.assertions.AssertOnColumnOfChangeEquality#hasValuesEqualTo(org.assertj.db.type.DateValue, org.assertj.db.type.DateValue)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertOnColumnOfChangeEquality_HasValuesEqualTo_Two_DateValue_Test extends AbstractTest {
  ...
  public void test_have_values_equal_to() {
    ...
    ChangeColumnAssert changeColumnAssert = changeAssert.column("var9");
    ChangeColumnAssert changeColumnAssert2 = changeColumnAssert.hasValuesEqualTo(DateValue.of(2014, 5, 24), DateValue.of(2014, 5, 24));
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    try {
      assertThat(changes).change().column("var9").hasValuesEqualTo(DateValue.of(2014, 5, 24), DateValue.of(2014, 5, 24));
  ...
  public void should_fail_because_value_at_end_point_is_different() {
    ...
    try {
      ...
      Assertions.assertThat(e.getMessage()).isEqualTo("[Column at index 8 (column name : VAR9) of Change at index 0 (on table : TEST and with primary key : [1]) of Changes on tables of 'sa/jdbc:h2:mem:test' source] \n"
