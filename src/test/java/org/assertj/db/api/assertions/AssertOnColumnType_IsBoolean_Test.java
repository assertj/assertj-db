...
public class AssertOnColumnType_IsBoolean_Test extends AbstractTest {
  ...
  public void test_is_boolean() {
    ...
    ChangeColumnAssert changeColumnAssertReturn2 = changeColumnAssert2.isBoolean(false);
    ...
    TableColumnAssert tableColumnAssertReturn1 = tableColumnAssert1.isBoolean(false);
    ...
    TableColumnAssert tableColumnAssertReturn2 = tableColumnAssert2.isBoolean(true);
  ...
  public void should_fail_because_value_have_different_type() {
    ...
    try {
      assertThat(table).column("var1").isBoolean(true);
      fail("An exception must be raised");
    } catch (AssertionError e) {
    ...
    try {
      assertThat(table2).column("var2").isBoolean(false);
      fail("An exception must be raised");
    } catch (AssertionError e) {
