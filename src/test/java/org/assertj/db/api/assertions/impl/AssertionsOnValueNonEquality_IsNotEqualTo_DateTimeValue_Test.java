 ...
 * {@link AssertionsOnValueNonEquality#isNotEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, Object, org.assertj.db.type.DateTimeValue)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnValueNonEquality_IsNotEqualTo_DateTimeValue_Test {
  ...
  public void test_is_not_equal_to() {
    ...
    tableAssert2 = AssertionsOnValueNonEquality.isNotEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-23 09:01:05"), DateTimeValue.of(
    ...
    tableAssert2 = AssertionsOnValueNonEquality.isNotEqualTo(tableAssert, info, Date.valueOf("2007-12-24"),
                                                             (DateTimeValue) null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueNonEquality.isNotEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-23 09:01:05"),
                                                             (DateTimeValue) null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
  ...
  public void should_fail_because_value_is_equal_to() {
    ...
    try {
      AssertionsOnValueNonEquality.isNotEqualTo(tableAssert, info, null, (DateTimeValue) null);
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                                    + "Expecting:%n"
  ...
  public void should_fail_because_value_is_not_a_date_time() {
    ...
    TableAssert tableAssert = assertThat(table);
    try {
      AssertionsOnValueNonEquality.isNotEqualTo(tableAssert, info, 8, DateTimeValue.of(DateValue.of(2007, 12, 23)));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                      + "Expecting:%n"
