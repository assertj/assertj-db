 ...
 * {@link  AssertOnValueCondition#doesNotHave(Condition)} method.
 *
 * @author Julien Roy
 */
public class AssertOnValueCondition_DoesNotHave_Test extends AbstractTest {
  ...
  /**
   * This method tests the {@code doesNotHave} assertion method.
   */
  @Test
  @NeedReload
  public void test_does_not_have() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.doesNotHave(zero);
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.doesNotHave(zero);
  ...
  public void should_fail_because_value_not_match_with_condition() {
    ...
    try {
      assertThat(changes).change().column("var3").valueAtEndPoint().doesNotHave(zero);
