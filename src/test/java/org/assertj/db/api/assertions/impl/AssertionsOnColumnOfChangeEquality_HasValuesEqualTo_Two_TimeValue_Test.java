 ...
 * {@link AssertionsOnColumnOfChangeEquality#hasValuesEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, Object, Object, TimeValue, TimeValue)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnColumnOfChangeEquality_HasValuesEqualTo_Two_TimeValue_Test {
  ...
  public void should_fail_because_value_at_start_point_is_different() throws Exception {
    ...
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info,
              Time.valueOf("09:01:05"), Time.valueOf("03:30:05"),
              TimeValue.of(9, 1), TimeValue.of(3, 30, 5));
  ...
  public void should_fail_because_value_at_end_point_is_different() throws Exception {
    ...
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info,
              Time.valueOf("09:01:00"), Time.valueOf("03:30:00"),
              TimeValue.of(9, 1), TimeValue.of(3, 30, 5));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
