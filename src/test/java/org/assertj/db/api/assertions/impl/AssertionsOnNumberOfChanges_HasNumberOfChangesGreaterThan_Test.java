 ...
 * {@link AssertionsOnNumberOfChanges#hasNumberOfChangesGreaterThan(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Changes, int)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnNumberOfChanges_HasNumberOfChangesGreaterThan_Test extends AbstractTest {

  /**
   * This method tests the {@code hasNumberOfChangesGreaterThan} assertion method.
   */
  @Test
  public void test_has_number_of_changes_greater_than_or_equal_to() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnNumberOfChanges.hasNumberOfChangesGreaterThan(tableAssert, info,
                                                                                         changes, 1);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }

  /**
   * This method should fail because the number of changes is less or equal.
   */
  @Test
  public void should_fail_because_number_of_changes_is_less_or_equal() throws Exception {
    ...
    Changes changes = getChanges(Arrays.asList(change, change));
    try {
      AssertionsOnNumberOfChanges.hasNumberOfChangesGreaterThan(tableAssert, info, changes, 2);
