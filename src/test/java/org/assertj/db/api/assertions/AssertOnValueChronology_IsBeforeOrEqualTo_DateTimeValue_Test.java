...
public class AssertOnValueChronology_IsBeforeOrEqualTo_DateTimeValue_Test extends AbstractTest {
  ...
  public void test_is_before_or_equal_to() throws ParseException {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isBeforeOrEqualTo(DateTimeValue.parse("2014-05-24T09:46:30"));
  ...
  public void should_fail_because_value_is_after() throws ParseException {
    ...
    try {
      assertThat(table).column("var10").value().isBeforeOrEqualTo(DateTimeValue.parse("2014-05-24T09:46:29"));
      fail("An exception must be raised");
    } catch (AssertionError e) {
