...
public class AssertionsOnValueEquality_IsEqualTo_String_Test {
    ...
    public void test_is_equal_to() {
        ...
        tableAssert2 = AssertionsOnValueEquality
            .isEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-23 00:00:00"), "2007-12-23");
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
        tableAssert2 = AssertionsOnValueEquality.isEqualTo(tableAssert, info, Time.valueOf("09:01:00"), "09:01");
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
        tableAssert2 = AssertionsOnValueEquality
            .isEqualTo(tableAssert, info, Date.valueOf("2007-12-23"), "2007-12-23T00:00:00");
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
        tableAssert2 = AssertionsOnValueEquality
            .isEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-23 09:01:00"), "2007-12-23T09:01");
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    }
    ...
    public void should_fail_because_value_is_not_equal_to() {
        ...
        try {
            AssertionsOnValueEquality
                .isEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-24 00:00:00"), "2007-12-23");
            fail("An exception must be raised");
        } catch (AssertionError e) {
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                                          + "Expecting:%n"
        ...
        try {
            AssertionsOnValueEquality
                .isEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-23 09:01:05"), "2007-12-23T09:01");
            fail("An exception must be raised");
        } catch (AssertionError e) {
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                                          + "Expecting:%n"
