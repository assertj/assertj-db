...
public class AssertOnColumnOfChangeEquality_HasValues_Two_Bytes_Test extends AbstractTest {
    ...
    public void test_has_values() {
        ...
        ChangeColumnAssert changeColumnAssert = changeAssert.column("var11");
        ChangeColumnAssert changeColumnAssert2 = changeColumnAssert.hasValues(bytesH2, bytesH2);
    ...
    public void should_fail_because_value_at_end_point_is_different() {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format(
                "[Column at index 10 (column name : VAR11) of Change at index 0 (on table : TEST and with primary key : [1]) of Changes on tables of 'sa/jdbc:h2:mem:test' source] %n"
