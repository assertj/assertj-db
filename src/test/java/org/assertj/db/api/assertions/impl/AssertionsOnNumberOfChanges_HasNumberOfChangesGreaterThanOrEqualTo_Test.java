 ...
 * {@link AssertionsOnNumberOfChanges#hasNumberOfChangesGreaterThanOrEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Changes, int)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnNumberOfChanges_HasNumberOfChangesGreaterThanOrEqualTo_Test extends AbstractTest {
  ...
  public void test_has_number_of_changes_greater_than_or_equal_to() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnNumberOfChanges.hasNumberOfChangesGreaterThanOrEqualTo(tableAssert, info,
                                                                                                  changes, 2);
  ...
  public void should_fail_because_number_of_changes_is_less() throws Exception {
    ...
    Changes changes = getChanges(Arrays.asList(change, change));
    try {
      AssertionsOnNumberOfChanges.hasNumberOfChangesGreaterThanOrEqualTo(tableAssert, info, changes, 3);
