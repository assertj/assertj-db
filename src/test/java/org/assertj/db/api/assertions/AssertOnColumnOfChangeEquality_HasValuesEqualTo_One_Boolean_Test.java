 ...
 * {@link org.assertj.db.api.assertions.AssertOnColumnOfChangeEquality#hasValuesEqualTo(Boolean)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertOnColumnOfChangeEquality_HasValuesEqualTo_One_Boolean_Test extends AbstractTest {
  ...
  public void test_have_values_equal_to() {
    ...
    ChangeColumnAssert changeColumnAssert2 = changeColumnAssert.hasValuesEqualTo(true);
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    try {
      assertThat(changes).change().column("var2").hasValuesEqualTo(true);
