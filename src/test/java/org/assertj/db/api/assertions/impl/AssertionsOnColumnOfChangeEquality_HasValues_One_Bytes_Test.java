 ...
 * {@link org.assertj.db.api.assertions.impl.AssertionsOnColumnOfChangeEquality#hasValues(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, Object, Object, byte[])} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnColumnOfChangeEquality_HasValues_One_Bytes_Test {
    ...
    public void should_fail_because_one_value_is_not_bytes() {
        ...
        try {
            AssertionsOnColumnOfChangeEquality
                .hasValues(tableAssert, info, "other", new byte[] { 2, 3 }, new byte[] { 0, 1 });
            fail("An exception must be raised");
        } catch (AssertionError e) {
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
