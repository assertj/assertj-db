...
public class AssertOnValueCondition_Satisfies_Test extends AbstractTest {
  ...
  /**
   * This method tests the {@code satisfies} assertion method.
   */
  @Test
  @NeedReload
  public void test_satisfies() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.satisfies(zero);
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.satisfies(zero);
  ...
  public void should_fail_because_value_not_match_with_condition() {
    ...
    try {
      assertThat(changes).change().column("var3").valueAtEndPoint().satisfies(zero);
