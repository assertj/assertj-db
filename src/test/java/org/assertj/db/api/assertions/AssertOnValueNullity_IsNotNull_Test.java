...
public class AssertOnValueNullity_IsNotNull_Test extends AbstractTest {
    ...
    public void test_is_not_null() {
        ...
        ChangeColumnValueAssert changeColumnValueAssert = assertThat(changes).change().column("var10")
                                                                             .valueAtEndPoint();
        ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isNotNull();
        ...
        TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isNotNull();
    ...
    public void should_fail_because_value_is_null() {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format(
                "[Value at end point of Column at index 2 (column name : VAR3) of Change at index 0 of Changes on test2 table of 'sa/jdbc:h2:mem:test' source] %n"
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(
                String.format("[Value at index 1 of Column at index 2 (column name : VAR3) of test2 table] %n"
                              + "Expecting actual not to be null"));
        }
    }
}
