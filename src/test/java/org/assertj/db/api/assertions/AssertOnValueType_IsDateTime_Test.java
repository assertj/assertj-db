...
public class AssertOnValueType_IsDateTime_Test extends AbstractTest {
  ...
  public void test_is_date_time() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isDateTime();
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isDateTime();
  ...
  public void should_fail_because_value_is_not_a_date_time() {
    ...
    try {
      assertThat(table).column("var1").value().isDateTime();
      fail("An exception must be raised");
    } catch (AssertionError e) {
