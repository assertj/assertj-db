...
public class AssertOnValueNullity_IsNull_Test extends AbstractTest {
  ...
  public void should_fail_because_value_is_not_null() {
    ...
    try {
      ...
      Assertions.assertThat(e.getMessage()).isEqualTo("[Value at end point of Column at index 2 (column name : VAR3) of Change at index 0 (with primary key : [1]) of Changes on test table of 'sa/jdbc:h2:mem:test' source] expected:<null> but was:<2>");
    }
    try {
