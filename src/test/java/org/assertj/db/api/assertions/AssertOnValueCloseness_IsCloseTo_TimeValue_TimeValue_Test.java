...
public class AssertOnValueCloseness_IsCloseTo_TimeValue_TimeValue_Test extends AbstractTest {
  ...
  public void test_is_close_to() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isCloseTo(TimeValue.of(9, 46, 30), TimeValue.of(0, 0));
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isCloseTo(TimeValue.of(9, 46, 30), TimeValue.of(0, 0));
    Assertions.assertThat(tableColumnValueAssert).isSameAs(tableColumnValueAssert2);
  }

  /**
   * This method should fail because the value is greater than or close to.
   */
  @Test
  @NeedReload
  public void should_fail_because_value_is_not_close_to() {
    ...
    try {
      assertThat(changes).change().column("var8").valueAtEndPoint().isCloseTo(TimeValue.of(9, 46, 31), TimeValue.of(0, 0, 0, 1));
