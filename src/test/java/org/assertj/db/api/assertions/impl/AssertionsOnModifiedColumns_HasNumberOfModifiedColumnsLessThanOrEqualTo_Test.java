 ...
 * {@link AssertionsOnModifiedColumns#hasNumberOfModifiedColumnsLessThanOrEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Change, int)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnModifiedColumns_HasNumberOfModifiedColumnsLessThanOrEqualTo_Test extends AbstractTest {
  ...
  public void test_has_number_of_modified_columns_less_than_or_equal_to() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnModifiedColumns.hasNumberOfModifiedColumnsLessThanOrEqualTo(tableAssert,
                                                                                                       info, change, 2);
  ...
  public void should_fail_because_number_of_modified_columns_is_greater() throws Exception {
    ...
    Change change = getChange(DataType.TABLE, "test", ChangeType.MODIFICATION, rowAtStartPoint, rowAtEndPoint);
    try {
      AssertionsOnModifiedColumns.hasNumberOfModifiedColumnsLessThanOrEqualTo(tableAssert, info, change, 1);
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                                    + "Expecting :%n"
                                                                    + "  number of modifications is less than or equal to 1%n"
                                                                    + "but was:%n"
                                                                    + "  2"));
    }
  }
