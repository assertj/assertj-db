    ...
    public void should_fail_because_values_are_different() throws Exception {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 2 (column name : VAR3) of test table] %n"
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 2 (column name : VAR3) of test2 table] %n"
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 3 (column name : VAR4) of test table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <\"30\">%n"
                                               + "to be equal to: %n"
                                               + "  <\"35\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 3 (column name : VAR4) of test2 table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <null>%n"
                                               + "to be equal to: %n"
                                               + "  <\"3\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 4 (column name : VAR5) of test table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <\"40\">%n"
                                               + "to be equal to: %n"
                                               + "  <\"45\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 4 (column name : VAR5) of test2 table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <null>%n"
                                               + "to be equal to: %n"
                                               + "  <\"4\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 5 (column name : VAR6) of test table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <\"50.60\">%n"
                                               + "to be equal to: %n"
                                               + "  <\"55.6\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 5 (column name : VAR6) of test2 table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <null>%n"
                                               + "to be equal to: %n"
                                               + "  <\"5.6\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 6 (column name : VAR7) of test table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <\"70.8\">%n"
                                               + "to be equal to: %n"
                                               + "  <\"75.8\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 6 (column name : VAR7) of test2 table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <null>%n"
                                               + "to be equal to: %n"
                                               + "  <\"7.8\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 12 (column name : VAR13) of test table] %n"
                                               + "Expecting that the value at index 2:%n"
                                               + "  <\"500.00\">%n"
                                               + "to be equal to: %n"
                                               + "  <\"505\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 12 (column name : VAR13) of test2 table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <null>%n"
                                               + "to be equal to: %n"
                                               + "  <\"5\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 13 (column name : VAR14) of test table] %n"
                                               + "Expecting that the value at index 2:%n"
                                               + "  <\"700.0\">%n"
                                               + "to be equal to: %n"
                                               + "  <\"750\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 13 (column name : VAR14) of test2 table] %n"
                                               + "Expecting that the value at index 1:%n"
                                               + "  <null>%n"
                                               + "to be equal to: %n"
                                               + "  <\"7\">"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 9 (column name : VAR10) of test table] %n"
                                               + "Expecting that the value at index 1:%n"
