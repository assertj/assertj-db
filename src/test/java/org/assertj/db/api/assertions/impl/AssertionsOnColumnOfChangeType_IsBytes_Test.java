...
public class AssertionsOnColumnOfChangeType_IsBytes_Test {
    ...
    public void test_is_bytes() {
        ...
        TableAssert tableAssert2 = AssertionsOnColumnOfChangeType
            .isBytes(tableAssert, info, new byte[] { 0, 1 }, new byte[] { 2, 3 }, false);
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
        tableAssert2 = AssertionsOnColumnOfChangeType
            .isBytes(tableAssert, info, new byte[] { 0, 1 }, new byte[] { 2, 3 }, true);
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
