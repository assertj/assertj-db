...
public class AssertOnColumnType_IsOfType_Test extends AbstractTest {
  ...
  public void test_is_of_type() {
    ...
    ChangeColumnAssert changeColumnAssertReturn2 = changeColumnAssert2.isOfType(ValueType.BOOLEAN, false);
    ...
    TableColumnAssert tableColumnAssertReturn1 = tableColumnAssert1.isOfType(ValueType.BOOLEAN, false);
    ...
    TableColumnAssert tableColumnAssertReturn2 = tableColumnAssert2.isOfType(ValueType.BOOLEAN, true);
