...
public class AssertOnColumnType_IsBytes_Test extends AbstractTest {
    ...
    public void test_is_bytes() {
        ...
        ChangeColumnAssert changeColumnAssert2 = assertThat(changes).change(1).column("var11");
        ChangeColumnAssert changeColumnAssertReturn2 = changeColumnAssert2.isBytes(false);
        Assertions.assertThat(changeColumnAssert2).isSameAs(changeColumnAssertReturn2);
        TableColumnAssert tableColumnAssert1 = assertThat(table).column("var11");
        TableColumnAssert tableColumnAssertReturn1 = tableColumnAssert1.isBytes(false);
        ...
        TableColumnAssert tableColumnAssertReturn2 = tableColumnAssert2.isBytes(true);
    ...
    public void should_fail_because_value_have_different_type() {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format(
                "[Column at index 10 (column name : VAR11) of Change at index 0 (on table : TEST and with primary key : [5]) of Changes on tables of 'sa/jdbc:h2:mem:test' source] %n"
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage())
                      .isEqualTo(String.format("[Column at index 10 (column name : VAR11) of test2 table] %n"
