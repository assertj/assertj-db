 ...
 * {@link  AssertionsOnValueCloseness#isCloseTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Value, org.assertj.db.type.DateTimeValue, org.assertj.db.type.DateValue)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnValueCloseness_IsCloseTo_DateTimeValue_DateValue_Test extends AbstractTest {
  ...
  public void test_is_close_to() throws Exception {
    ...
    tableAssert2 = AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(
            ...
            DateValue.of(2007, 12, 23), TimeValue.of(9, 1)), DateValue.of(0, 0, 0));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(null, null), (DateTimeValue) null, DateValue.of(0, 0, 0));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
  ...
  public void should_fail_because_value_is_not_close_to() throws Exception {
    ...
    try {
      AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(null, Date.valueOf("2007-12-24")),
                                           (DateTimeValue) null, DateValue.of(0, 1, 0));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                                    + "Expecting:%n"
    ...
    try {
      AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(null, Timestamp.valueOf("2007-12-23 09:01:05")),
                                           (DateTimeValue) null, DateValue.of(1, 0, 0));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                                    + "Expecting:%n"
