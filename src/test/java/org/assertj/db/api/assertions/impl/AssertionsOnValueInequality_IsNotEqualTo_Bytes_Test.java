...
public class AssertionsOnValueInequality_IsNotEqualTo_Bytes_Test extends AbstractTest {
  ...
  public void test_is_not_equal_to() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnValueInequality.isNotEqualTo(tableAssert, info, getValue(null, new byte[]{2, 3}), new byte[]{0, 1});
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueInequality.isNotEqualTo(tableAssert, info, getValue(null, new byte[]{2, 3}), (byte[]) null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
