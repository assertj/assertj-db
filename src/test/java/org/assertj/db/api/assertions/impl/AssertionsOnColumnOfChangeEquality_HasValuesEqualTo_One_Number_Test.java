 ...
 * {@link org.assertj.db.api.assertions.impl.AssertionsOnColumnOfChangeEquality#hasValuesEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, Object, Object, Number)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnColumnOfChangeEquality_HasValuesEqualTo_One_Number_Test {
  ...
  public void test_have_values_equal_to() {
    ...
    TableAssert tableAssert2 = AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, 1, 1,
                                                                                   1);
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    TableAssert tableAssert = assertThat(table);
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, 0, 1, 1);
  ...
  public void should_fail_because_value_at_end_point_is_different() {
    ...
    TableAssert tableAssert = assertThat(table);
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, 1, 2, 1);
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
  ...
  public void should_fail_because_one_value_is_not_a_number() {
    ...
    TableAssert tableAssert = assertThat(table);
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, "other", 1, 1);
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
