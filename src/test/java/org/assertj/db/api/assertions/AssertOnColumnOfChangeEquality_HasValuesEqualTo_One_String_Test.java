 ...
 * {@link org.assertj.db.api.assertions.AssertOnColumnOfChangeEquality#hasValuesEqualTo(String)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertOnColumnOfChangeEquality_HasValuesEqualTo_One_String_Test extends AbstractTest {
  ...
  public void test_have_values_equal_to() {
    ...
    ChangeColumnAssert changeColumnAssert2 = changeColumnAssert.hasValuesEqualTo("text");
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    try {
      assertThat(changes).change().column("var12").hasValuesEqualTo("test");
  ...
  public void should_fail_because_value_at_end_point_is_different() {
    ...
    try {
      assertThat(changes).change().column("var12").hasValuesEqualTo("text");
      fail("An exception must be raised");
    } catch (AssertionError e) {
