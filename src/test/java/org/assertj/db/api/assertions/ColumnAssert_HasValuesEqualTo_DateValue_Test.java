...
/**
 * Test on the {@code hasValuesEqualTo} assertion method on {@code Column} for the date values.
 * 
 * @author Régis Pouiller
 * 
 */
public class ColumnAssert_HasValuesEqualTo_DateValue_Test extends AbstractTest {
  ...
  public void test_hasValuesEqualTo_assertion() {
    ...
    assertThat(table)
        .column("var9").hasValuesEqualTo(DateValue.of(2014, 5, 24), DateValue.of(2014, 5, 30), 
            DateValue.of(2014, 5, 30), DateValue.of(2014, 5, 30))
            .hasValuesEqualTo("2014-05-24", "2014-05-30", "2014-05-30", "2014-05-30");

    Table table2 = new Table(source, "test2");

    assertThat(table2)
        .column("var9").hasValuesEqualTo(DateValue.of(2014, 5, 24), null);
  }
  ...
  public void should_fail_hasValuesEqualTo_assertion_because_column_is_boolean() {
    try {
      ...
      assertThat(table)
          .column(1).as("var2 type").hasValuesEqualTo(DateValue.of(2014, 5, 24), DateValue.of(2014, 5, 30), 
              DateValue.of(2014, 5, 30), DateValue.of(2014, 5, 30));
  ...
  public void should_fail_hasValuesEqualTo_assertion_because_value_is_different_because_is_null() {
    try {
      ...
      assertThat(table)
          .column("var9").hasValuesEqualTo(DateValue.of(2014, 5, 24), DateValue.of(2014, 5, 24));
  ...
  public void should_fail_hasValuesEqualTo_assertion_because_value_is_different() {
    try {
      ...
      assertThat(table)
          .column("var9").hasValuesEqualTo(DateValue.of(2014, 5, 25), DateValue.of(2014, 5, 24));
