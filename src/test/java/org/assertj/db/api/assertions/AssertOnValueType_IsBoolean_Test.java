...
public class AssertOnValueType_IsBoolean_Test extends AbstractTest {
  ...
  public void test_is_boolean() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isBoolean();
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isBoolean();
