 ...
 *
 */
public class AssertionsOnColumnEquality_HasValues_DateValue_Test {
    ...
    public void test_has_values() {
        ...
        List<Object> list = new ArrayList<Object>(
            Arrays.asList(Date.valueOf("2007-12-23"), Date.valueOf("2002-07-25"), null));
        TableAssert tableAssert2 = AssertionsOnColumnEquality
            .hasValues(tableAssert, info, list, DateValue.of(2007, 12, 23),
                       DateValue.of(2002, 7, 25), null);
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
        list = new ArrayList<Object>(
            Arrays.asList(Timestamp.valueOf("2007-12-23 00:00:00"), Timestamp.valueOf("2002-07-25 00:00:00"), null));
    ...
    public void should_fail_because_values_are_different() {
        ...
        try {
            List<Object> list = new ArrayList<Object>(
                Arrays.asList(Timestamp.valueOf("2007-12-23 00:00:00"), Timestamp.valueOf("2002-07-25 00:00:05")));
            AssertionsOnColumnEquality.hasValues(tableAssert, info, list, DateValue.of(2007, 12, 23),
