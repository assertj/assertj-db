 ...
 * {@link org.assertj.db.api.assertions.AssertOnColumnOfChangeEquality#hasValuesEqualTo(Number)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertOnColumnOfChangeEquality_HasValuesEqualTo_One_Number_Test extends AbstractTest {
  ...
  public void test_have_values_equal_to() {
    ...
    ChangeColumnAssert changeColumnAssert2 = changeColumnAssert.hasValuesEqualTo(2);
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    try {
      assertThat(changes).change().column("var3").hasValuesEqualTo(3);
  ...
  public void should_fail_because_value_at_end_point_is_different() {
    ...
    try {
      assertThat(changes).change().column("var3").hasValuesEqualTo(2);
      fail("An exception must be raised");
    } catch (AssertionError e) {
