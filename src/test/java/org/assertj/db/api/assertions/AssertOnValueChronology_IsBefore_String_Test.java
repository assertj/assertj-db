...
public class AssertOnValueChronology_IsBefore_String_Test extends AbstractTest {
  ...
  public void test_is_before() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isBefore("2014-05-25");
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isBefore("2014-05-25");
  ...
  public void should_fail_because_value_is_after_or_equal_to() {
    ...
    try {
      assertThat(table).column("var10").value().isBefore("2014-05-24");
      fail("An exception must be raised");
    } catch (AssertionError e) {
