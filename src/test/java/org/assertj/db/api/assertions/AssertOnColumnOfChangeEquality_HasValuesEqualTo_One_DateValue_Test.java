 ...
 * {@link org.assertj.db.api.assertions.AssertOnColumnOfChangeEquality#hasValuesEqualTo(org.assertj.db.type.DateValue)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertOnColumnOfChangeEquality_HasValuesEqualTo_One_DateValue_Test extends AbstractTest {
  ...
  public void test_have_values_equal_to() {
    ...
    ChangeColumnAssert changeColumnAssert2 = changeColumnAssert.hasValuesEqualTo(DateValue.of(2014, 5, 24));
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    try {
      assertThat(changes).change().column("var9").hasValuesEqualTo(DateValue.of(2014, 5, 24));
