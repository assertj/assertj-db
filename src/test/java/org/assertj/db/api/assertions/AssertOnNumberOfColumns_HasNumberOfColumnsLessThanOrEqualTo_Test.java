...
public class AssertOnNumberOfColumns_HasNumberOfColumnsLessThanOrEqualTo_Test extends AbstractTest {
  ...
  /**
   * This method tests the {@code hasNumberOfColumnsLessThanOrEqualTo} assertion method.
   */
  @Test
  @NeedReload
  public void test_has_number_of_columns_less_than_or_equal() {
    ...
    ChangeAssert changeAssert2 = changeAssert.hasNumberOfColumnsLessThanOrEqualTo(5);
    ...
    ChangeRowAssert changeRowAssert2 = changeRowAssert.hasNumberOfColumnsLessThanOrEqualTo(5);
    Assertions.assertThat(changeRowAssert).isSameAs(changeRowAssert2);

    TableAssert tableAssert = assertThat(table);
    TableAssert tableAssert2 = tableAssert.hasNumberOfColumnsLessThanOrEqualTo(5);
    Assertions.assertThat(tableAssert).isSameAs(tableAssert2);

    TableRowAssert tableRowAssert = assertThat(table).row();
    TableRowAssert tableRowAssert2 = tableRowAssert.hasNumberOfColumnsLessThanOrEqualTo(5);
    Assertions.assertThat(tableRowAssert).isSameAs(tableRowAssert2);
  }

  /**
   * This method should fail because the number of columns is less.
   */
  @Test
  @NeedReload
