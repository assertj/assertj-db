...
public class AssertionsOnValueEquality_IsEqualTo_DateValue_Test {
    ...
    public void test_is_equal_to() {
        ...
        TableAssert tableAssert2 = AssertionsOnValueEquality
            .isEqualTo(tableAssert, info, Date.valueOf("2007-12-23"), DateValue.of(2007, 12, 23));
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
        tableAssert2 = AssertionsOnValueEquality
            .isEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-23 00:00:00"), DateValue.of(2007, 12, 23));
        Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    }
    ...
    public void should_fail_because_value_is_not_equal_to() {
        ...
        try {
            AssertionsOnValueEquality
                .isEqualTo(tableAssert, info, Date.valueOf("2007-12-24"), DateValue.of(2007, 12, 23));
        ...
        try {
            AssertionsOnValueEquality
                .isEqualTo(tableAssert, info, Timestamp.valueOf("2007-12-24 00:00:00"), DateValue.of(2007, 12, 23));
            fail("An exception must be raised");
        } catch (AssertionError e) {
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
                                                                          + "Expecting:%n"
