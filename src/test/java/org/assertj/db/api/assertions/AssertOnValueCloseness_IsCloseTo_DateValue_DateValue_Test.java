...
public class AssertOnValueCloseness_IsCloseTo_DateValue_DateValue_Test extends AbstractTest {
  ...
  public void test_is_close_to() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isCloseTo(DateValue.of(2014, 5, 24), DateValue.of(0, 0, 0));
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isCloseTo(DateValue.of(2014, 5, 24), DateValue.of(0, 0, 0));
  ...
  public void should_fail_because_value_is_not_close_to() {
    ...
    try {
      assertThat(table).column("var9").value().isCloseTo(DateValue.of(2014, 5, 23), DateValue.of(0, 0, 0));
      fail("An exception must be raised");
    } catch (AssertionError e) {
