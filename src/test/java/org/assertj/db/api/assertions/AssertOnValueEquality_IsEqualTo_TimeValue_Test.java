...
public class AssertOnValueEquality_IsEqualTo_TimeValue_Test extends AbstractTest {
  ...
  public void test_is_equal_to() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isEqualTo(TimeValue.of(9, 46, 30));
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isEqualTo(TimeValue.of(9, 46, 30));
  ...
  public void should_fail_because_value_is_not_equal_to() {
    ...
    try {
      assertThat(table).column("var8").value().isEqualTo(TimeValue.of(9, 46, 31));
      fail("An exception must be raised");
    } catch (AssertionError e) {
