...
public class AssertOnValueNonEquality_IsNotEqualTo_UUID_Test extends AbstractTest {
    ...
    public void test_is_not_equal_to() {
        ...
        ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isNotEqualTo(UUID.fromString("0e2a1269-eff0-4233-b87b-b53e8b6f164d"));
        ...
        TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isNotEqualTo(UUID.fromString("0e2a1269-eff0-4233-b87b-b53e8b6f164d"));
    ...
    public void should_fail_because_value_is_equal_to() {
        ...
        try {
            assertThat(changes).change().column("var15").valueAtEndPoint().isNotEqualTo(UUID.fromString("f96ec595-ce91-47cc-9152-ccc8ac48aad6"));
            fail("An exception must be raised");
        } catch (AssertionError e) {
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[Value at end point of Column at index 14 (column name : VAR15) of Change at index 0 (with primary key : [1]) of Changes on test table of 'sa/jdbc:h2:mem:test' source] %n"
                    + "Expecting:%n"
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[Value at index 0 of Column at index 14 (column name : VAR15) of test table] %n"
                    + "Expecting:%n"
                    + "  <f96ec595-ce91-47cc-9152-ccc8ac48aad6>%n"
                    + "not to be equal to: %n"
                    + "  <f96ec595-ce91-47cc-9152-ccc8ac48aad6>"));
