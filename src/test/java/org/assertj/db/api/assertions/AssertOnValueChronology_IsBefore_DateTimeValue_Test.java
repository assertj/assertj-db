...
public class AssertOnValueChronology_IsBefore_DateTimeValue_Test extends AbstractTest {
  ...
  public void test_is_before() throws ParseException {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isBefore(
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isBefore(
      DateTimeValue.parse("2014-05-24T09:46:31"));
  ...
  public void should_fail_because_value_is_after_or_equal_to() throws ParseException {
    ...
    try {
      assertThat(changes).change().column("var10").valueAtEndPoint().isBefore(
    ...
    try {
      assertThat(table).column("var10").value().isBefore(DateTimeValue.parse("2014-05-24T09:46:30"));
      fail("An exception must be raised");
    } catch (AssertionError e) {
