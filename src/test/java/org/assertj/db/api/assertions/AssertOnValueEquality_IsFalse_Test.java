...
public class AssertOnValueEquality_IsFalse_Test extends AbstractTest {
    ...
    public void test_is_false() {
        ...
        ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isFalse();
        Assertions.assertThat(changeColumnValueAssert).isSameAs(changeColumnValueAssert2);

        TableColumnValueAssert tableColumnValueAssert = assertThat(table).column("var2").value(1);
        TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isFalse();
    ...
    public void should_fail_because_value_is_true() {
        ...
        try {
            assertThat(table).column("var2").value().isFalse();
            fail("An exception must be raised");
        } catch (AssertionError e) {
