...
public class AssertOnValueChronology_IsAfterOrEqualTo_DateTimeValue_Test extends AbstractTest {
  ...
  public void should_fail_because_value_is_before() throws ParseException {
    ...
    try {
      assertThat(changes).change().column("var10").valueAtEndPoint().isAfterOrEqualTo(
    ...
    try {
      assertThat(table).column("var10").value().isAfterOrEqualTo(DateTimeValue.parse("2014-05-24T09:46:31"));
      fail("An exception must be raised");
    } catch (AssertionError e) {
