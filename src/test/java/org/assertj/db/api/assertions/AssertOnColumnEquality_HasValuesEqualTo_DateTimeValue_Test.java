 ...
 * {@link org.assertj.db.api.assertions.AssertOnColumnEquality#hasValuesEqualTo(org.assertj.db.type.DateTimeValue...)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertOnColumnEquality_HasValuesEqualTo_DateTimeValue_Test extends AbstractTest {
  ...
  public void test_has_values_equal_to() throws Exception {
    ...
    TableColumnAssert tableColumnAssertReturn = tableColumnAssert.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue.of(9, 46, 30)),
    ...
    TableColumnAssert tableColumnAssertReturn2 = tableColumnAssert2.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue.of(9, 46, 30)),
                                                                                     null);
    Assertions.assertThat(tableColumnAssert2).isSameAs(tableColumnAssertReturn2);

    TableColumnAssert tableColumnAssert3 = assertThat(table).column("var9");
    TableColumnAssert tableColumnAssertReturn3 = tableColumnAssert3.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24)),
                                                                                   DateTimeValue.of(DateValue.of(2014, 5, 30)),
                                                                                   DateTimeValue.of(DateValue.of(2014, 5, 30)),
                                                                                   DateTimeValue.of(DateValue.of(2014, 5, 30)));
    ...
    TableColumnAssert tableColumnAssertReturn4 = tableColumnAssert4.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24)),
                                                                                     null);
  ...
  public void should_fail_because_values_are_different() throws Exception {
    ...
    TableColumnAssert tableColumnAssert = assertThat(table).column("var10");
    try {
      tableColumnAssert.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue.of(9, 46, 30)),
    ...
    TableColumnAssert tableColumnAssert2 = assertThat(table2).column("var10");
    try {
      tableColumnAssert2.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24), TimeValue.of(9, 46, 30)),
    ...
    TableColumnAssert tableColumnAssert3 = assertThat(table).column("var9");
    try {
      tableColumnAssert3.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24)),
    ...
    TableColumnAssert tableColumnAssert4 = assertThat(table2).column("var9");
    try {
      tableColumnAssert4.hasValuesEqualTo(DateTimeValue.of(DateValue.of(2014, 5, 24)),
                                          DateTimeValue.of(DateValue.of(2014, 5, 24)));
      fail("An exception must be raised");
    } catch (AssertionError e) {
