 ...
 * {@link org.assertj.db.api.assertions.impl.AssertionsOnColumnOfChangeEquality#hasValuesEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, Object, Object, byte[], byte[])} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnColumnOfChangeEquality_HasValuesEqualTo_Two_Bytes_Test {
  ...
  public void test_have_values_equal_to() {
    ...
    TableAssert tableAssert2 = AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, new byte[] {0, 1}, new byte[] {2, 3}, new byte[] {0, 1}, new byte[] {2, 3});
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    TableAssert tableAssert = assertThat(table);
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, new byte[] {0, 1}, new byte[] {2, 3}, new byte[] {0, 0}, new byte[] {2, 3});
  ...
  public void should_fail_because_value_at_end_point_is_different() {
    ...
    TableAssert tableAssert = assertThat(table);
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, new byte[] {0, 1}, new byte[] {2, 3}, new byte[] {0, 1}, new byte[] {2, 2});
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
  ...
  public void should_fail_because_one_value_is_not_bytes() {
    ...
    TableAssert tableAssert = assertThat(table);
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info, "other", new byte[] {2, 3}, new byte[] {0, 1}, new byte[] {2, 3});
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
