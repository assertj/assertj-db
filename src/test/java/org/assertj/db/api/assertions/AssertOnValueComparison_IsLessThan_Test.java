...
public class AssertOnValueComparison_IsLessThan_Test extends AbstractTest {
    ...
    public void test_is_less_than() {
        ...
        ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isLessThan(3);
        ...
        TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isLessThan(3);
    ...
    public void should_fail_because_value_is_greater_than_or_equal_to() {
        ...
        try {
            assertThat(table).column("var3").value().isLessThan(2);
            fail("An exception must be raised");
        } catch (AssertionError e) {
