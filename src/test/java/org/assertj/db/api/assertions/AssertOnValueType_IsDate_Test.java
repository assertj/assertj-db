...
public class AssertOnValueType_IsDate_Test extends AbstractTest {
  ...
  public void test_is_date() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isDate();
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isDate();
  ...
  public void should_fail_because_value_is_not_a_date() {
    ...
    try {
      assertThat(table).column("var1").value().isDate();
      fail("An exception must be raised");
    } catch (AssertionError e) {
