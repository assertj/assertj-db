...
public class AssertOnValueEquality_IsZero_Test extends AbstractTest {
    ...
    public void test_is_zero() {
        ...
        ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isZero();
        ...
        TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isZero();
    ...
    public void should_fail_because_value_is_not_zero() {
        ...
        try {
            assertThat(table).column("var3").value().isZero();
            fail("An exception must be raised");
        } catch (AssertionError e) {
