 ...
 * {@link AssertionsOnChangeType#isModification(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Change)}} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnChangeType_IsModification_Test extends AbstractTest {
  ...
  public void test_is_modification() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnChangeType.isModification(tableAssert, info, change);
  ...
  public void should_fail_because_type_of_change_is_different() throws Exception {
    ...
    try {
      AssertionsOnChangeType.isModification(tableAssert, info, change);
