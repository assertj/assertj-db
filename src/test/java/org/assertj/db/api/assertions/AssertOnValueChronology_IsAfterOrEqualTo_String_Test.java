...
public class AssertOnValueChronology_IsAfterOrEqualTo_String_Test extends AbstractTest {
  ...
  public void test_is_after_or_equal_to() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isAfterOrEqualTo("2014-05-24");
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isAfterOrEqualTo("2014-05-24");
  ...
  public void should_fail_because_value_is_before() {
    ...
    try {
      assertThat(table).column("var10").value().isAfterOrEqualTo("2014-05-25");
      fail("An exception must be raised");
    } catch (AssertionError e) {
