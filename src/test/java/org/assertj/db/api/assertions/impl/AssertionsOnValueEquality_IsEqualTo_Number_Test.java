...
public class AssertionsOnValueEquality_IsEqualTo_Number_Test extends AbstractTest {
  ...
  public void test_is_equal_to() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnValueEquality.isEqualTo(tableAssert, info, getValue(null, 8), 8);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueEquality.isEqualTo(tableAssert, info, getValue(null, null), (Number) null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
