 ...
 * {@link AssertionsOnModifiedColumns#hasNumberOfModifiedColumnsGreaterThan(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Change, int)} method.
 *
 * @author Régis Pouiller
 */
public class AssertionsOnModifiedColumns_HasNumberOfModifiedColumnsGreaterThan_Test extends AbstractTest {
  ...
  public void test_has_number_of_modified_columns_greater_than() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnModifiedColumns.hasNumberOfModifiedColumnsGreaterThan(tableAssert,
      info, change,
      1);
  ...
  /**
   * This method should fail because the number of modified columns is less or equal.
   */
  @Test
  public void should_fail_because_number_of_modified_columns_is_less_or_equal() throws Exception {
    ...
    Change change = getChange(DataType.TABLE, "test", ChangeType.MODIFICATION, rowAtStartPoint, rowAtEndPoint);
    try {
      AssertionsOnModifiedColumns.hasNumberOfModifiedColumnsGreaterThan(tableAssert, info, change, 3);
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
        + "Expecting :%n"
        + "  number of modifications is greater than 3%n"
        + "but was:%n"
        + "  2"));
    }
  }
