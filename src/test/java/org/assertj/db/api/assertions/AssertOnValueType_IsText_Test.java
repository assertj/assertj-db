...
public class AssertOnValueType_IsText_Test extends AbstractTest {
    ...
    public void test_is_text() {
        ...
        ChangeColumnValueAssert changeColumnValueAssert = assertThat(changes).change().column("var12")
                                                                             .valueAtEndPoint();
        ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isText();
        ...
        TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isText();
    ...
    public void should_fail_because_value_is_not_a_text() {
        ...
        try {
            assertThat(table).column("var1").value().isText();
            fail("An exception must be raised");
        } catch (AssertionError e) {
