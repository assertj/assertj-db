 ...
 * {@link AssertionsOnDataType#isOnDataType(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Change, org.assertj.db.type.DataType)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnDataType_IsOnDataType_Test extends AbstractTest {
    ...
    public void test_is_on_data_type() throws Exception {
        ...
        TableAssert tableAssert2 = AssertionsOnDataType.isOnDataType(tableAssert, info, change, DataType.TABLE);
    ...
    public void should_fail_because_data_type_is_different() throws Exception {
        ...
        Change change = getChange(DataType.TABLE, "test", ChangeType.CREATION, rowAtStartPoint, rowAtEndPoint);
        try {
            AssertionsOnDataType.isOnDataType(tableAssert, info, change, DataType.REQUEST);
