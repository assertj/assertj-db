 ...
 * {@link org.assertj.db.api.assertions.AssertOnColumnEquality#hasValuesEqualTo(org.assertj.db.type.DateValue...)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertOnColumnEquality_HasValuesEqualTo_DateValue_Test extends AbstractTest {
  ...
  public void test_has_values_equal_to() throws Exception {
    ...
    TableColumnAssert tableColumnAssertReturn = tableColumnAssert.hasValuesEqualTo(
    ...
    TableColumnAssert tableColumnAssertReturn2 = tableColumnAssert2.hasValuesEqualTo(DateValue.of(2014, 5, 24),
                                                                                     null);
    Assertions.assertThat(tableColumnAssert2).isSameAs(tableColumnAssertReturn2);
    TableColumnAssert tableColumnAssert3 = assertThat(table2).column("var10");
    TableColumnAssert tableColumnAssertReturn3 = tableColumnAssert3.hasValuesEqualTo(DateValue.of(2014, 5, 24),
                                                                                     null);
  ...
  public void should_fail_because_values_are_different() throws Exception {
    ...
    TableColumnAssert tableColumnAssert = assertThat(table).column("var9");
    try {
      tableColumnAssert.hasValuesEqualTo(DateValue.of(2014, 5, 24),
    ...
    TableColumnAssert tableColumnAssert2 = assertThat(table2).column("var9");
    try {
      tableColumnAssert2.hasValuesEqualTo(DateValue.of(2014, 5, 24),
                                          DateValue.of(2014, 5, 24));
      fail("An exception must be raised");
    } catch (AssertionError e) {
    ...
    TableColumnAssert tableColumnAssert3 = assertThat(table2).column("var10");
    try {
      tableColumnAssert3.hasValuesEqualTo(DateValue.of(2014, 5, 23),
                                          null);
      fail("An exception must be raised");
    } catch (AssertionError e) {
