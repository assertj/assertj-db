...
public class AssertOnColumnEquality_HasValues_UUID_Test extends AbstractTest{
    ...
    public void test_has_values() throws Exception {
        ...
        TableColumnAssert tableColumnAssertReturn2 = tableColumnAssert2.hasValues(UUID.fromString("30B443AE-C0C9-4790-9BEC-CE1380808435"), null);
    ...
    public void should_fail_because_values_are_different() throws Exception {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[Column at index 14 (column name : VAR15) of test table] %n"
