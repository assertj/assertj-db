...
public class AssertOnValueChronology_IsAfter_TimeValue_Test extends AbstractTest {
  ...
  public void test_is_after() throws ParseException {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isAfter(TimeValue.parse("09:46:29"));
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isAfter(TimeValue.parse("09:46:29"));
