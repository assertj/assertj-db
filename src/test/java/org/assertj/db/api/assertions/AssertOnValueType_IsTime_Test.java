...
public class AssertOnValueType_IsTime_Test extends AbstractTest {
  ...
  public void test_is_time() {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isTime();
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isTime();
  ...
  public void should_fail_because_value_is_not_a_time() {
    ...
    try {
      assertThat(table).column("var1").value().isTime();
      fail("An exception must be raised");
    } catch (AssertionError e) {
