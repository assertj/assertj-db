...
public class AssertOnValueEquality_IsEqualTo_DateValue_Test extends AbstractTest {
    ...
    public void test_is_equal_to() {
        ...
        ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isEqualTo(DateValue.of(2014, 5, 24));
        ...
        TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isEqualTo(DateValue.of(2014, 5, 24));
    ...
    public void should_fail_because_value_is_not_equal_to() {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format(
                "[Value at end point of Column at index 8 (column name : VAR9) of Change at index 0 (with primary key : [1]) of Changes on test table of 'sa/jdbc:h2:mem:test' source] %n"
                + "Expecting:%n"
                + "  <2014-05-24>%n"
                + "to be equal to: %n"
                + "  <2014-05-23>"));
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(
                String.format("[Value at index 0 of Column at index 8 (column name : VAR9) of test table] %n"
                              + "Expecting:%n"
                              + "  <2014-05-24>%n"
                              + "to be equal to: %n"
                              + "  <2014-05-23>"));
