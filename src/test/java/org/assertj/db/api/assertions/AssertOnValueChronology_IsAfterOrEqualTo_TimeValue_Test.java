...
public class AssertOnValueChronology_IsAfterOrEqualTo_TimeValue_Test extends AbstractTest {
  ...
  public void test_is_after_or_equal_to() throws ParseException {
    ...
    ChangeColumnValueAssert changeColumnValueAssert2 = changeColumnValueAssert.isAfterOrEqualTo(
            TimeValue.parse("09:46:29"));
    ...
    TableColumnValueAssert tableColumnValueAssert2 = tableColumnValueAssert.isAfterOrEqualTo(
            TimeValue.parse("09:46:29"));
  ...
  public void should_fail_because_value_is_before() throws ParseException {
    ...
    try {
      ...
      Assertions.assertThat(e.getMessage()).isEqualTo("[Value at end point of Column at index 7 (column name : VAR8) of Change at index 0 (with primary key : [1]) of Changes on test table of 'sa/jdbc:h2:mem:test' source] \n"
                                                      + "Expecting:\n"
                                                      + "  <09:46:30.000000000>\n"
    ...
    try {
      assertThat(table).column("var8").value().isAfterOrEqualTo(TimeValue.parse("09:46:31"));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[Value at index 0 of Column at index 7 (column name : VAR8) of test table] \n"
                                                      + "Expecting:\n"
                                                      + "  <09:46:30.000000000>\n"
                                                      + "to be after or equal to \n"
                                                      + "  <09:46:31.000000000>");
