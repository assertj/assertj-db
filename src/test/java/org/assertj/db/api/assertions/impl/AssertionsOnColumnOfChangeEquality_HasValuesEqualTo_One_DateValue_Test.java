 ...
 * {@link AssertionsOnColumnOfChangeEquality#hasValuesEqualTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, Object, Object, DateValue)} method.
 *
 * @author Régis Pouiller
 *
 */
public class AssertionsOnColumnOfChangeEquality_HasValuesEqualTo_One_DateValue_Test {
  ...
  public void test_have_values_equal_to() {
    ...
    TableAssert tableAssert2 = AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info,
            Date.valueOf("2007-12-23"), Date.valueOf("2007-12-23"),
            DateValue.of(2007, 12, 23));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info,
            Timestamp.valueOf("2007-12-23 00:00:00"), Timestamp.valueOf("2007-12-23 00:00:00"),
            DateValue.of(2007, 12, 23));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
  ...
  public void should_fail_because_value_at_start_point_is_different() {
    ...
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info,
              Timestamp.valueOf("2007-12-23 00:00:05"), Timestamp.valueOf("2002-07-25 00:00:00"),
              DateValue.of(2002, 7, 25));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
                                                      + "Expecting that start point:\n"
                                                      + "  <2007-12-23T00:00:05.000000000>\n"
                                                      + "to be equal to: \n"
                                                      + "  <2002-07-25>");
    }
  }
  ...
  public void should_fail_because_value_at_end_point_is_different() {
    ...
    try {
      AssertionsOnColumnOfChangeEquality.hasValuesEqualTo(tableAssert, info,
              Timestamp.valueOf("2007-12-23 00:00:00"), Timestamp.valueOf("2002-07-25 00:00:05"),
              DateValue.of(2007, 12, 23));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo("[description] \n"
