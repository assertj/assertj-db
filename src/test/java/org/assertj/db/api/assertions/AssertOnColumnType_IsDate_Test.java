...
public class AssertOnColumnType_IsDate_Test extends AbstractTest {
    ...
    public void test_is_date() {
        ...
        ChangeColumnAssert changeColumnAssert2 = assertThat(changes).change(1).column("var9");
        ChangeColumnAssert changeColumnAssertReturn2 = changeColumnAssert2.isDate(false);
        Assertions.assertThat(changeColumnAssert2).isSameAs(changeColumnAssertReturn2);
        TableColumnAssert tableColumnAssert1 = assertThat(table).column("var9");
        TableColumnAssert tableColumnAssertReturn1 = tableColumnAssert1.isDate(false);
        ...
        TableColumnAssert tableColumnAssertReturn2 = tableColumnAssert2.isDate(true);
    ...
    public void should_fail_because_value_have_different_type() {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(String.format(
                "[Column at index 8 (column name : VAR9) of Change at index 0 (on table : TEST and with primary key : [5]) of Changes on tables of 'sa/jdbc:h2:mem:test' source] %n"
