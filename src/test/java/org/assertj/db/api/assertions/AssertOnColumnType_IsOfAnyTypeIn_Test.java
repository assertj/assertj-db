...
public class AssertOnColumnType_IsOfAnyTypeIn_Test extends AbstractTest {
    ...
    public void test_is_of_any_of_types() {
        ...
        ChangeColumnAssert changeColumnAssertReturn2 = changeColumnAssert2
            .isOfAnyTypeIn(ValueType.BOOLEAN, ValueType.TEXT);
        ...
        TableColumnAssert tableColumnAssertReturn1 = tableColumnAssert1
            .isOfAnyTypeIn(ValueType.BOOLEAN, ValueType.TEXT);
