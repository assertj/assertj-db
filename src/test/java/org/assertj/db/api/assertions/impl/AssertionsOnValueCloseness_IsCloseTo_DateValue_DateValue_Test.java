 ...
 * {@link  AssertionsOnValueCloseness#isCloseTo(org.assertj.db.api.AbstractAssert, org.assertj.core.api.WritableAssertionInfo, org.assertj.db.type.Value, org.assertj.db.type.DateValue, org.assertj.db.type.DateValue)} method.
 *
 * @author Régis Pouiller
 */
public class AssertionsOnValueCloseness_IsCloseTo_DateValue_DateValue_Test extends AbstractTest {
  ...
  public void test_is_close_to() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(
      null, Date.valueOf("2007-12-23")), DateValue.of(2007, 12, 23), DateValue.of(0, 0, 0));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(
      null, Timestamp.valueOf("2007-12-23 00:00:00")), DateValue.of(2007, 12, 23), DateValue.of(0, 0, 1));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(null, null), (DateValue) null, DateValue.of(0, 1, 0));
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
  ...
  public void should_fail_because_value_is_not_close_to() throws Exception {
    ...
    try {
      AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(null, Date.valueOf("2007-12-24")),
        DateValue.of(2007, 12, 23), DateValue.of(0, 0, 0));
    ...
    try {
      AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(null, Date.valueOf("2007-12-24")),
        (DateValue) null, DateValue.of(0, 1, 0));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
        + "Expecting:%n"
        ...
        + "to be close to: %n"
        + "  <null> %n"
        + " with tolerance <   0-01-00>"));
    }
    try {
      AssertionsOnValueCloseness.isCloseTo(tableAssert, info, getValue(null, Timestamp.valueOf("2007-12-24 00:00:00")),
        (DateValue) null, DateValue.of(1, 0, 0));
      fail("An exception must be raised");
    } catch (AssertionError e) {
      Assertions.assertThat(e.getMessage()).isEqualTo(String.format("[description] %n"
        + "Expecting:%n"
