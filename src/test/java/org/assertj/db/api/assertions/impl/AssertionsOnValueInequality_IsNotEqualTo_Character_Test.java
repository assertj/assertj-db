...
public class AssertionsOnValueInequality_IsNotEqualTo_Character_Test extends AbstractTest {
  ...
  public void test_is_not_equal_to() throws Exception {
    ...
    TableAssert tableAssert2 = AssertionsOnValueInequality.isNotEqualTo(tableAssert, info, getValue(null, 'T'), 't');
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueInequality.isNotEqualTo(tableAssert, info, getValue(null, "T"), 't');
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
    tableAssert2 = AssertionsOnValueInequality.isNotEqualTo(tableAssert, info, getValue(null, true), (Character) null);
    Assertions.assertThat(tableAssert2).isSameAs(tableAssert);
  }
