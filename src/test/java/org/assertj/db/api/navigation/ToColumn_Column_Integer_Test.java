...
public class ToColumn_Column_Integer_Test extends AbstractTest {
    ...
    public void test_column_with_index_from_change() throws Exception {
        ...
        Assertions.assertThat(fieldValueAtStartPoint.get(changeColumnAssert0))
                  .isEqualTo(fieldValueAtStartPoint.get(changeColumnAssertBis0)).isEqualTo(new BigDecimal("3"));
        Assertions.assertThat(fieldValueAtStartPoint.get(changeColumnAssert1))
                  .isEqualTo(fieldValueAtStartPoint.get(changeColumnAssertBis1)).isEqualTo("Worthington");
        Assertions.assertThat(fieldValueAtStartPoint.get(changeColumnAssert2))
                  .isEqualTo(fieldValueAtStartPoint.get(changeColumnAssertBis2)).isEqualTo("Sam");
        Assertions.assertThat(fieldValueAtStartPoint.get(changeColumnAssert3))
                  .isEqualTo(fieldValueAtStartPoint.get(changeColumnAssertBis3)).isEqualTo(
            Date.valueOf("1976-08-02"));
        Assertions.assertThat(fieldValueAtStartPoint.get(changeColumnAssert4))
                  .isEqualTo(fieldValueAtStartPoint.get(changeColumnAssertBis4)).isEqualTo(
    ...
    public void test_column_with_index_from_table() throws Exception {
        ...
        Assertions.assertThat(columnId1.getValuesList()).isEqualTo(columnIdBis1.getValuesList())
                  .containsExactly("Weaver",
                                   "Phoenix",
                                   "Worthington");
        Assertions
