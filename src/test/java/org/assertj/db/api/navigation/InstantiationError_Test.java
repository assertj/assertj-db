...
public class InstantiationError_Test extends AbstractTest {
    ...
    public void should_fail_because_mistake_in_instantiation_of_column() throws Exception {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(
                "There is an exception 'org.assertj.db.api.navigation.InstantiationError_Test.<init>(org.assertj.db.api.TableAssert, org.assertj.db.type.Column)'\n"
    ...
    public void should_fail_because_mistake_in_instantiation_of_row() throws Exception {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(
                "There is an exception 'org.assertj.db.api.navigation.InstantiationError_Test.<init>(org.assertj.db.api.TableAssert, org.assertj.db.type.Row)'\n"
                + "\t in the instantiation of the assertion org.assertj.db.api.navigation.InstantiationError_Test\n"
    ...
    public void should_fail_because_mistake_in_instantiation_of_value() throws Exception {
        ...
        try {
            ...
            Assertions.assertThat(e.getMessage()).isEqualTo(
                "There is an exception 'org.assertj.db.api.navigation.InstantiationError_Test.<init>(org.assertj.db.api.TableColumnAssert, java.lang.Object)'\n"
                + "\t in the instantiation of the assertion org.assertj.db.api.navigation.InstantiationError_Test\n"
