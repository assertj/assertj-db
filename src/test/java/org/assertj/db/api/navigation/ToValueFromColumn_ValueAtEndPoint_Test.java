...
/**
 * Tests on {@link org.assertj.db.api.navigation.ToValueFromColumn} class :
 * {@link ToValueFromColumn#valueAtEndPoint()} method.
 *
...
public class ToValueFromColumn_ValueAtEndPoint_Test extends AbstractTest {
    ...
    public void test_value_at_end_point() throws Exception {
        ...
        ChangeColumnValueAssert changeModificationRowValueAssertBis = changeColumnValueModificationAssert
            .valueAtEndPoint();
