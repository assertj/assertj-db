...
public class ToChange_ChangeOnTableWithPks_Test extends AbstractTest {
    ...
    @Test
    @NeedReload
    public void test_change_on_table_with_pks() throws Exception {
        ...
        Assertions.assertThat(fieldChange.get(changeAssert0)).isSameAs(fieldChange.get(changeAssertBis0))
                  .isSameAs(changesList.get(3));
        Assertions.assertThat(fieldChange.get(changeAssert1)).isSameAs(fieldChange.get(changeAssertBis1))
                  .isSameAs(changesList.get(6));
        Assertions.assertThat(fieldChange.get(changeAssert2)).isSameAs(fieldChange.get(changeAssertBis2))
