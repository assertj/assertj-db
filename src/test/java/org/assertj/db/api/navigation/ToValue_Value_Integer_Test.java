...
public class ToValue_Value_Integer_Test extends AbstractTest {
    ...
    public void test_value_from_row_of_change_with_index() throws Exception {
        ...
        Assertions.assertThat(fieldValue.get(changeRowValueAssert0)).isSameAs(fieldValue.get(changeRowValueAssertBis0))
                  .isEqualTo(new BigDecimal("4"));
        Assertions.assertThat(fieldValue.get(changeRowValueAssert1)).isSameAs(fieldValue.get(changeRowValueAssertBis1))
                  .isEqualTo("Murray");
        Assertions.assertThat(fieldValue.get(changeRowValueAssert2)).isSameAs(fieldValue.get(changeRowValueAssertBis2))
                  .isEqualTo("Bill");
        Assertions.assertThat(fieldValue.get(changeRowValueAssert3)).isSameAs(fieldValue.get(changeRowValueAssertBis3))
                  .isEqualTo(
                      Date.valueOf("1950-09-21"));
        Assertions.assertThat(fieldValue.get(changeRowValueAssert4)).isSameAs(fieldValue.get(changeRowValueAssertBis4))
                  .isEqualTo(
    ...
    public void test_value_from_column_of_table_with_index() throws Exception {
        ...
        Assertions.assertThat(fieldValue.get(tableColumnValueAssert0))
                  .isSameAs(fieldValue.get(tableColumnValueAssertBis0)).isEqualTo(new BigDecimal("1"));
        Assertions.assertThat(fieldValue.get(tableColumnValueAssert1))
                  .isSameAs(fieldValue.get(tableColumnValueAssertBis1)).isEqualTo(new BigDecimal("2"));
        Assertions.assertThat(fieldValue.get(tableColumnValueAssert2))
                  .isSameAs(fieldValue.get(tableColumnValueAssertBis2)).isEqualTo(new BigDecimal("3"));
    }
    ...
    public void test_value_from_row_of_table_with_index() throws Exception {
        ...
        Assertions.assertThat(fieldValue.get(tableRowValueAssert0)).isSameAs(fieldValue.get(tableRowValueAssertBis0))
                  .isEqualTo(new BigDecimal("1"));
        Assertions.assertThat(fieldValue.get(tableRowValueAssert1)).isSameAs(fieldValue.get(tableRowValueAssertBis1))
                  .isEqualTo("Weaver");
        Assertions.assertThat(fieldValue.get(tableRowValueAssert2)).isSameAs(fieldValue.get(tableRowValueAssertBis2))
                  .isEqualTo("Sigourney");
        Assertions.assertThat(fieldValue.get(tableRowValueAssert3)).isSameAs(fieldValue.get(tableRowValueAssertBis3))
                  .isEqualTo(Date.valueOf("1949-10-08"));
        Assertions.assertThat(fieldValue.get(tableRowValueAssert4)).isSameAs(fieldValue.get(tableRowValueAssertBis4))
    ...
    public void test_value_from_column_of_request_with_index() throws Exception {
        ...
        Assertions.assertThat(fieldValue.get(requestColumnValueAssert0))
                  .isSameAs(fieldValue.get(requestColumnValueAssertBis0)).isEqualTo(new BigDecimal("1"));
        Assertions.assertThat(fieldValue.get(requestColumnValueAssert1))
                  .isSameAs(fieldValue.get(requestColumnValueAssertBis1)).isEqualTo(new BigDecimal("2"));
        Assertions.assertThat(fieldValue.get(requestColumnValueAssert2))
                  .isSameAs(fieldValue.get(requestColumnValueAssertBis2)).isEqualTo(new BigDecimal("3"));
    }
    ...
    public void test_value_from_row_of_request_with_index() throws Exception {
        ...
        Assertions.assertThat(fieldValue.get(requestRowValueAssert0))
                  .isSameAs(fieldValue.get(requestRowValueAssertBis0)).isEqualTo(new BigDecimal("1"));
        Assertions.assertThat(fieldValue.get(requestRowValueAssert1))
                  .isSameAs(fieldValue.get(requestRowValueAssertBis1)).isEqualTo("Weaver");
        Assertions.assertThat(fieldValue.get(requestRowValueAssert2))
                  .isSameAs(fieldValue.get(requestRowValueAssertBis2)).isEqualTo("Sigourney");
        Assertions.assertThat(fieldValue.get(requestRowValueAssert3))
                  .isSameAs(fieldValue.get(requestRowValueAssertBis3)).isEqualTo(Date.valueOf("1949-10-08"));
        Assertions.assertThat(fieldValue.get(requestRowValueAssert4))
                  .isSameAs(fieldValue.get(requestRowValueAssertBis4))
                  .isEqualTo(UUID.fromString("30B443AE-C0C9-4790-9BEC-CE1380808435"));
    }
}
