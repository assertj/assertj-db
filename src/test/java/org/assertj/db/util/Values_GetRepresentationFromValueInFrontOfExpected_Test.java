...
public class Values_GetRepresentationFromValueInFrontOfExpected_Test {
    ...
    public void test_getRepresentationFromValueInFrontOfExpected_for_dates() {
        ...
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(date, DateValue.of(2007, 12, 23)))
            .isEqualTo(DateValue.from(date));
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(date, DateTimeValue
            .of(DateValue.of(2007, 12, 23), TimeValue.of(9, 1)))).isEqualTo(DateTimeValue.of(DateValue.from(date)));
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(date, "")).isEqualTo("2007-12-23");
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(date, "T"))
    ...
    public void test_getRepresentationFromValueInFrontOfExpected_for_datetime() {
        ...
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(timestamp, null))
            .isEqualTo(DateTimeValue.from(timestamp));
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(timestamp, ""))
            .isEqualTo("2007-12-23T09:01:06.000000003");
    }
    ...
    public void test_getRepresentationFromValueInFrontOfExpected_for_bytes() {
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(new byte[] { 1, 2 }, null))
    ...
    public void test_getRepresentationFromValueInFrontOfExpected_for_UUID() {
        assertThat(Values.getRepresentationFromValueInFrontOfExpected(
            UUID.fromString("30B443AE-C0C9-4790-9BEC-CE1380808435"), null))
