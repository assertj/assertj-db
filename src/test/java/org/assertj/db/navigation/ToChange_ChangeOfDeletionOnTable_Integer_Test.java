...
public class ToChange_ChangeOfDeletionOnTable_Integer_Test extends AbstractTest {
  ...
  public void test_change_of_deletion_on_table_with_index_with_displays() throws Exception {
    ...
    assertThat(map).hasSize(0);
    assertThat(map.get(null)).isNull();
    ChangeDisplay changeDisplay0 = changesDisplay.changeOfDeletionOnTable("actor", 0);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).isNull();
    assertThat(map.get(ChangeType.DELETION)).hasSize(1);
    assertThat(map.get(ChangeType.DELETION).get("actor")).isEqualTo(1);
    ChangeDisplay changeDisplay1 = changesDisplay.changeOfDeletionOnTable("interpretation", 0);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).isNull();
    assertThat(map.get(ChangeType.DELETION)).hasSize(2);
    assertThat(map.get(ChangeType.DELETION).get("interpretation")).isEqualTo(1);
    ...
    ChangeDisplay changeDisplayAgain0 = changesDisplay.changeOfDeletionOnTable("actor", 0);
    ...
    assertThat(map).hasSize(0);
    assertThat(map.get(null)).isNull();
    ChangeDisplay changeDisplayBis0 = changesDisplayBis.changeOfDeletionOnTable("actor", 0);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).isNull();
    assertThat(map.get(ChangeType.DELETION)).hasSize(1);
    assertThat(map.get(ChangeType.DELETION).get("actor")).isEqualTo(1);
    ChangeDisplay changeDisplayBis1 = changeDisplayBis0.changeOfDeletionOnTable("interpretation", 0);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).isNull();
    assertThat(map.get(ChangeType.DELETION)).hasSize(2);
    assertThat(map.get(ChangeType.DELETION).get("interpretation")).isEqualTo(1);
    ...
    ChangeDisplay changeDisplayBisAgain0 = changeDisplayBis1.changeOfDeletionOnTable("actor", 0);
