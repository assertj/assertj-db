...
public class ToChange_ChangeOnTable_Integer_Test extends AbstractTest {
  ...
  public void test_change_on_table_with_index_with_displays() throws Exception {
    ...
    assertThat(map).hasSize(0);
    assertThat(map.get(null)).isNull();
    ChangeDisplay changeDisplay0 = changesDisplay.changeOnTable("actor", 0);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).hasSize(1);
    assertThat(map.get(null).get("actor")).isEqualTo(1);
    ChangeDisplay changeDisplay1 = changesDisplay.changeOnTable("actor", 1);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).hasSize(1);
    assertThat(map.get(null).get("actor")).isEqualTo(2);
    ChangeDisplay changeDisplay2 = changesDisplay.changeOnTable("actor", 2);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).hasSize(1);
    assertThat(map.get(null).get("actor")).isEqualTo(3);
    try {
    ...
    ChangeDisplay changeDisplayAgain0 = changesDisplay.changeOnTable("actor", 0);
    ...
    assertThat(map).hasSize(0);
    assertThat(map.get(null)).isNull();
    ChangeDisplay changeDisplayBis0 = changesDisplayBis.changeOnTable("actor", 0);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).hasSize(1);
    assertThat(map.get(null).get("actor")).isEqualTo(1);
    ChangeDisplay changeDisplayBis1 = changeDisplayBis0.changeOnTable("actor", 1);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).hasSize(1);
    assertThat(map.get(null).get("actor")).isEqualTo(2);
    ChangeDisplay changeDisplayBis2 = changeDisplayBis1.changeOnTable("actor", 2);
    assertThat(map).hasSize(1);
    assertThat(map.get(null)).hasSize(1);
    assertThat(map.get(null).get("actor")).isEqualTo(3);
    try {
    ...
    ChangeDisplay changeDisplayBisAgain0 = changeDisplayBis2.changeOnTable("actor", 0);
