...
public class Changes_GetChangesOfType_Test extends AbstractTest {
    ...
    public void test_getChangesOfTable() {
        ...
        Changes changesRequest = new Changes(new Request(source,
                                                         ...
                                                         + " from interpretation, movie, actor "
                                                         + " where interpretation.id_movie = movie.id "
        ...
        assertThat(changesCreation.getChangesList().get(0).getColumnsNameList())
            .containsExactly("ID", "NAME", "FIRSTNAME",
                             "BIRTH", "ACTOR_IMDB");
        ...
        assertThat(changesCreation.getChangesList().get(1).getColumnsNameList())
        ...
        assertThat(changesCreation.getChangesList().get(2).getColumnsNameList())
        ...
        assertThat(changesModification.getChangesList().get(0).getColumnsNameList())
            .containsExactly("ID", "NAME", "FIRSTNAME",
                             "BIRTH", "ACTOR_IMDB");
        ...
        assertThat(changesModification.getChangesList().get(1).getColumnsNameList())
            .containsExactly("ID", "ID_MOVIE", "ID_ACTOR", "CHARACTER");
        ...
        assertThat(changesModification.getChangesList().get(2).getColumnsNameList())
            .containsExactly("ID", "TITLE", "YEAR", "MOVIE_IMDB");
        ...
        assertThat(changesDeletion.getChangesList().get(0).getColumnsNameList())
            .containsExactly("ID", "NAME", "FIRSTNAME",
                             "BIRTH", "ACTOR_IMDB");
        ...
        assertThat(changesDeletion.getChangesList().get(1).getColumnsNameList())
            .containsExactly("ID", "ID_MOVIE", "ID_ACTOR", "CHARACTER");
        ...
        assertThat(changesRequestCreation.getChangesList().get(0).getDataName()).isEqualTo(
            "select interpretation.id, character, movie.title, actor.name  from interpretation, movie, actor  where interpretation.id_movie = movie.id  and interpretation.id_actor = actor.id ");
        assertThat(changesRequestCreation.getChangesList().get(0).getChangeType()).isEqualTo(ChangeType.CREATION);
        assertThat(changesRequestCreation.getChangesList().get(0).getColumnsNameList())
            .containsExactly("ID", "CHARACTER", "TITLE",
                             "NAME");
        ...
        assertThat(changesRequestModification.getChangesList().get(0).getDataName()).isEqualTo(
            "select interpretation.id, character, movie.title, actor.name  from interpretation, movie, actor  where interpretation.id_movie = movie.id  and interpretation.id_actor = actor.id ");
        assertThat(changesRequestModification.getChangesList().get(0).getChangeType())
            .isEqualTo(ChangeType.MODIFICATION);
        assertThat(changesRequestModification.getChangesList().get(0).getColumnsNameList())
            .containsExactly("ID", "CHARACTER", "TITLE",
                             "NAME");
        assertThat(changesRequestModification.getChangesList().get(0).getRowAtStartPoint().getValuesList())
            .containsExactly(
                new BigDecimal(3), "Dr Grace Augustine", "Avatar", "Weaver");
        assertThat(changesRequestModification.getChangesList().get(0).getRowAtEndPoint().getValuesList())
            .containsExactly(
        ...
        assertThat(changesRequestDeletion.getChangesList().get(0).getDataName()).isEqualTo(
            "select interpretation.id, character, movie.title, actor.name  from interpretation, movie, actor  where interpretation.id_movie = movie.id  and interpretation.id_actor = actor.id ");
        assertThat(changesRequestDeletion.getChangesList().get(0).getChangeType()).isEqualTo(ChangeType.DELETION);
        assertThat(changesRequestDeletion.getChangesList().get(0).getColumnsNameList())
            .containsExactly("ID", "CHARACTER", "TITLE",
                             "NAME");
