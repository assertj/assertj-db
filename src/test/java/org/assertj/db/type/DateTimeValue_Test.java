...
public class DateTimeValue_Test extends AbstractTest {
    ...
    public void test_equals() {
        ...
        assertThat(DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(0, 1)).equals(DateValue.of(2007, 12, 23)))
            .isFalse();
        assertThat(
            DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(0, 0, 6)).equals(DateValue.of(2007, 12, 23)))
            .isFalse();
        assertThat(
    ...
    public void test_hashCode() {
        ...
        assertThat(DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(9, 1, 6, 3)).hashCode())
            .isEqualTo(2876124);
        ...
        assertThat(DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(0, 0, 0, 3)).hashCode())
            .isEqualTo(2607038);
    }
