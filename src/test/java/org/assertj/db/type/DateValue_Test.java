...
public class DateValue_Test extends AbstractTest {
    ...
    public void test_equals() {
        ...
        assertThat(DateValue.of(2007, 12, 23).equals(DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(0, 0))))
            .isTrue();
        assertThat(
            DateValue.of(2007, 12, 23).equals(DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(0, 0, 0))))
            .isTrue();
        assertThat(
        ...
        assertThat(DateValue.of(2007, 12, 23).equals(DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(0, 1))))
            .isFalse();
        assertThat(
            DateValue.of(2007, 12, 23).equals(DateTimeValue.of(DateValue.of(2007, 12, 23), TimeValue.of(0, 0, 6))))
            .isFalse();
        assertThat(
        ...
        assertThat(
            ...
            .isFalse();
        assertThat(
            DateValue.of(2007, 12, 23).equals(DateTimeValue.of(DateValue.of(2007, 1, 23), TimeValue.of(0, 0, 0, 0))))
            .isFalse();
        assertThat(
