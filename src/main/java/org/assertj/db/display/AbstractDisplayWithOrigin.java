 ...
 */
public abstract class AbstractDisplayWithOrigin<E extends AbstractDisplayWithOrigin<E, O>, O extends Origin>
        extends AbstractDisplay<E> {
   ...
   * Constructor.
   *
   * @param selfType Type of this assertion class : a sub-class of {@code AbstractDisplayWithOrigin}.
   * @param origin The assertion of {@link org.assertj.db.navigation.origin.Origin}.
   */
  AbstractDisplayWithOrigin(Class<E> selfType, O origin) {
    super(selfType);
    this.origin = origin;
  }
