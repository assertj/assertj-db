 ...
 */
public abstract class AbstractDisplayWithOriginWithColumnsAndRows<E extends AbstractDisplayWithOriginWithColumnsAndRows<E, O, D, A, C, CV, R, RV>, O extends OriginWithColumnsAndRows<C, R>, D extends AbstractDbData<D>, A extends AbstractDbDisplay<D, A, C, CV, R, RV>, C extends AbstractColumnDisplay<D, A, C, CV, R, RV>, CV extends AbstractColumnValueDisplay<D, A, C, CV, R, RV>, R extends AbstractRowDisplay<D, A, C, CV, R, RV>, RV extends AbstractRowValueDisplay<D, A, C, CV, R, RV>>
   ...
   * Constructor.
   *
   * @param selfType Type of this assertion class : a sub-class of {@code AbstractDisplayWithOriginWithColumnsAndRows}.
   * @param origin The assertion of {@link org.assertj.db.navigation.origin.Origin}.
   */
  AbstractDisplayWithOriginWithColumnsAndRows(Class<E> selfType, O origin) {
