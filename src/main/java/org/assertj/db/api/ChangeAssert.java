...
public class ChangeAssert
    ...
    private ChangeColumnAssert getChangeColumnAssertInstance(int index) {
        ...
        indexNextColumn = index + 1;
        return instance
            .as("Column at index " + index + " (column name : " + columnName + ") of " + info.descriptionText());
    }
    ...
    public ChangeAssert hasNumberOfColumns(int expected) {
        return AssertionsOnNumberOfColumns
            .hasNumberOfColumns(myself, info, change.getColumnsNameList().size(), expected);
    }
