...
public class AssertionsOnValueComparison {
     ...
     */
    public static <A extends AbstractAssert> A isGreaterThan(A assertion, WritableAssertionInfo info, Object value,
                                                             Number expected) {
     ...
     */
    public static <A extends AbstractAssert> A isLessThan(A assertion, WritableAssertionInfo info, Object value,
                                                          Number expected) {
        AssertionsOnValueType.isNumber(assertion, info, value);
        if (compare(value, expected) < 0) {
            return assertion;
     ...
     */
    public static <A extends AbstractAssert> A isGreaterThanOrEqualTo(A assertion, WritableAssertionInfo info,
                                                                      Object value, Number expected) {
        AssertionsOnValueType.isNumber(assertion, info, value);
        if (compare(value, expected) >= 0) {
            return assertion;
        }
     ...
     */
    public static <A extends AbstractAssert> A isLessThanOrEqualTo(A assertion, WritableAssertionInfo info,
                                                                   Object value, Number expected) {
        AssertionsOnValueType.isNumber(assertion, info, value);
        if (compare(value, expected) <= 0) {
            return assertion;
