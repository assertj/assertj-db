...
public class ShouldBeValueType extends BasicErrorMessageFactory {
    ...
    private static final String EXPECTED_MESSAGE_WITH_INDEX =
        "%nExpecting that the value at index %s:%n  <%s>%nto be of type%n"
        + "  <%s>%nbut was of type%n  <%s>";
     ...
     * @return the created {@code ErrorMessageFactory}.
     */
    public static ErrorMessageFactory shouldBeValueType(int index, Object actual, ValueType expected,
                                                        ValueType tested) {
